...
REC2="andhikalfariz@localhost"
REC1="operatingsystems@vlsm.org"
FILES="my*.asc my*.txt my*.sh"
SHA="SHA256SUM"

[ -d /home/andhikalfariz/RESULT/ ] || mkdir -p /home/andhikalfariz/RESULT/
pushd /home/andhikalfariz/RESULT/
for II in W?? ; do
    [ -d $II ] || continue
...
for II in /home/andhikalfariz/RESULT/myW*.tar.bz2.asc ; do
